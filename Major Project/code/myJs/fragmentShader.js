...
gl.shaderSource(fragmentShader, [
	...
	'void main(){',
		...
		//Directional
		'vec3 unitNormal = normalize(surfaceNormal);',
		//'vec3 unitLightVector = normalize(reverseLightDirection);', //this aint being used!
		'float uncheckedBrightness = dot(unitNormal, reverseLightDirection);',
		'vec3 diffuse = uncheckedBrightness * lightColour ;',
		
		
		
		//New specular, reverseLightDirection/unitLightVector might have to be re-reversed here
		//unitLightVector is reverseLightDirection normalized!
		...
		//'vec3 diffuse = brightness * lightColour ;', //10,10,10 for extra intensity
